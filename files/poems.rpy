...
init 5 python:
    reg_poem_trans("long_wait", ru_long_wait)
    reg_poem_trans("poem_sunshine", ru_poem_sunshine)
    reg_poem_trans("poem_bottles", ru_poem_bottles)
    reg_poem_trans("poem_flower", ru_poem_flower)
    reg_poem_trans("poem_last", ru_poem_last)
    reg_poem_trans("poem_fruits", ru_poem_fruits)
    reg_poem_trans("poem_angel", ru_poem_angel)
    reg_poem_trans("poem_leaf", ru_poem_leaf)
    reg_poem_trans("poem_prose", ru_poem_prose)
    reg_poem_trans("poem_afterlight", ru_poem_afterlight)
    reg_poem_trans("poem_val", ru_poem_val)
